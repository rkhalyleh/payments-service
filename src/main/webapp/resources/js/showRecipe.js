...
//		                    });
//		                    var paymentsServiceTable = $("<table brecipe='1' width='100%'>");
...
//		                    });
//		                    var title = $("<span>paymentsService details for the sales recipe (" + item.salesrecipe + "):</span>");
...
//		                    
//		                    var $customButton = $("<a>")
//		                    	.html("<span style='padding-left: 5px;' id='" +linkId + "'>View paymentsService (<span class=\"recipeTotalpaymentsService_" + getRandomNumber() + "\">" + item.paymentsService.length + "</span>)</span>")
//		                    	.click(function(e) {
